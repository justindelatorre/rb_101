...
=begin
Explanation:
This is expected, since the values in the key-value pairs within each Munsters
respective Hash can be changed. Spot's method mutates the caller in this case.
=end
