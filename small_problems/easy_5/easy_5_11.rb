...
Solution:
Array#each returns the original collection, which then gets String#join applied
to it. After poking around in irb, it looks like String#join creates a new
Array.
=end
